package com.e_commerceapp.activity.ui.inicio;
...
import com.e_commerceapp.adapter.CategoriaAdapter;
import com.e_commerceapp.adapter.PlatillosRecomendadosAdapter;
import com.e_commerceapp.adapter.SliderAdapter;
import com.e_commerceapp.communication.Communication;
import com.e_commerceapp.communication.MostrarBadgeCommunication;
import com.e_commerceapp.entity.SliderItem;
import com.e_commerceapp.entity.service.DetallePedido;
import com.e_commerceapp.entity.service.Platillo;
import com.e_commerceapp.utils.Carrito;
import com.e_commerceapp.viewmodel.CategoriaViewModel;
import com.e_commerceapp.viewmodel.PlatilloViewModel;
...
public class InicioFragment extends Fragment implements Communication, MostrarBadgeCommunication {
    ...
    private void loadData() {
        ...
        lista.add(new SliderItem(R.drawable.arroz_de_leche, "Los Mejores Platillos"));
        lista.add(new SliderItem(R.drawable.mil_hojas, "Los Mejores Postres"));
        lista.add(new SliderItem(R.drawable.cafe, "Cafe a tu gusto"));
        lista.add(new SliderItem(R.drawable.galletas, "Galletas de todos los gusto"));
